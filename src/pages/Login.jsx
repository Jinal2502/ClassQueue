      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center space-x-2 mb-4">
            ...
            <span className="text-white font-semibold text-2xl">DoubtQueue</span>
          </div>
          <p className="text-gray-400">Student Doubt Resolution System</p>
        </div>
            ...
            {isSignUp && (
              <div>
                ...
                <input
                  ...
                  required={isSignUp}
                  className="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-md text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
